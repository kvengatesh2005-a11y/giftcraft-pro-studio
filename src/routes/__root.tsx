...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "br_Treasure_Trove — Handcrafted Gifts & Keepsakes" },
      {
        name: "description",
        content:
          "Handpicked gifts, resin art, jewellery and personalised keepsakes, shipped worldwide from India.",
      },
      { name: "author", content: "br_innovate" },
